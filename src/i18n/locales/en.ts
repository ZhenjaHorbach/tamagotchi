...
const en = {
  ...
  speech: {
    ...
    hungry: ["psst. tummy update: it’s rumbling.", "i’m not SAYING feed me, but i’m looking at you meaningfully."],
    sad: ["it got a bit quiet in here… you’re still there, right?", "just a small grey-cloud kind of day."],
    happy: ["today feels like a sun-on-the-floor kind of day.", "everything is, against all odds, pretty great."],
