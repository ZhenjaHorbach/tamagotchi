...
const pl: typeof en = {
  ...
  speech: {
    ...
    hungry: ["pst. raport z brzuszka: burczy.", "nie MÓWIĘ, żebyś mnie nakarmił, ale patrzę znacząco."],
    sad: ["zrobiło się cicho… jesteś tam jeszcze, prawda?", "po prostu dzień szarej chmurki."],
    happy: ["dziś jest dzień słońca na podłodze.", "wszystko, wbrew wszystkiemu, jest całkiem nieźle."],
    neutral: ["po prostu się krzątam. przełożyłem listek.", "czy ty czasem po prostu… wibujesz? ja wibuję."],
  },
  settings: {
    title: 'Ustawienia',
