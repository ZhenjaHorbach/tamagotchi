...
const es: typeof en = {
  ...
  speech: {
    greet: ["¡oh! has vuelto. te guardé el sitio calentito.", "hola hola — ¿trajiste algo de picar?"],
    ...
    hungry: ["pss. informe de la pancita: ruge.", "no DIGO que me alimentes, pero te miro con intención."],
    ...
    neutral: ["solo trasteando. recoloqué una hoja.", "¿alguna vez solo… fluyes? yo estoy fluyendo."],
  },
  settings: {
    title: 'Ajustes',
