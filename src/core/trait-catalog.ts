...
export const ENERGY_TYPES: readonly AxisOption[] = [
  {
    id: 'lazy',
    label: 'Lazy',
    note: 'naps a lot, tires fast when active',
    modifiers: { energyDecay: 0.7, playEnergyCost: 1.4 },
  },
  { id: 'balanced', label: 'Balanced', modifiers: { energyDecay: 1, playEnergyCost: 1 } },
  {
    id: 'energetic',
    label: 'Energetic',
    note: 'burns energy fast, plays cheaply',
    modifiers: { energyDecay: 1.3, playEnergyCost: 0.7 },
  },
];
...
export const APPETITES: readonly AxisOption[] = [
  {
    id: 'glutton',
    label: 'Glutton',
    note: 'hungry often, a good meal fills it well',
    modifiers: { hungerDecay: 1.5, feedGain: 1.3 },
  },
  { id: 'balanced', label: 'Balanced', modifiers: { hungerDecay: 1, feedGain: 1 } },
  {
    id: 'light_eater',
    label: 'Light eater',
    note: 'rarely hungry, picks at its food',
    modifiers: { hungerDecay: 0.7, feedGain: 0.7 },
  },
];
...
export const NEEDINESS: readonly AxisOption[] = [
  ...
  { id: 'balanced', label: 'Balanced', modifiers: { joyDecay: 1 } },
  {
    id: 'independent',
    label: 'Independent',
    note: 'content on its own',
    modifiers: { joyDecay: 0.6 },
  },
];
...
export const PLAYFULNESS: readonly AxisOption[] = [
  {
    id: 'playful',
    label: 'Playful',
    note: 'lights up when you play',
    modifiers: { playJoyGain: 1.5 },
  },
  { id: 'balanced', label: 'Balanced', modifiers: { playJoyGain: 1 } },
  {
    id: 'serious',
    label: 'Serious',
    note: 'play helps less; prefers calm company',
    modifiers: { playJoyGain: 0.7 },
  },
];
...
export const QUIRKS = [
  ...
  'loves the rain',
  'hoards shiny things',
  'hums old tunes to itself',
  'naps in the most inconvenient corners',
  'is suspicious of the moon',
  'keeps a secret favorite rock',
  'quietly narrates its own day',
  'insists it saw a ghost once',
  'rearranges its things when bored',
] as const;
